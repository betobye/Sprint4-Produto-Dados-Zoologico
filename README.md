...
Em uma aplicação real, seria necessário treinar o modelo com dados históricos reais de visitação, clima, eventos, feriados, campanhas, férias escolares e outras variáveis externas.
 campanhas, férias escolares e outras variáveis externas.
